...
REPOSITORY="https://raw.githubusercontent.com/Azure-Samples/AI-Video-Intelligence-Solution-Accelerator/${PCS_RELEASE_VERSION}/pcs/cli/solutions/remotemonitoring/single-vm"
